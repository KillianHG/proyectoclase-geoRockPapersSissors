...
public class MainActivity extends AppCompatActivity {
    ...
    final Fragment fragment1 = new PositionFragment();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fm.beginTransaction()
                .add(R.id.selected_fragment, fragment1, "1")
                .hide(fragment2)
                .commit();

        fm.beginTransaction()
                .add(R.id.selected_fragment, fragment2, "2")
                .hide(fragment2)
                .commit();

        fm.beginTransaction()
                .add(R.id.selected_fragment, fragment3, "3")
                .hide(fragment3)
                .commit();
